    ...
    <div class="scrum-form">
        <form on:submit|preventDefault={handleFormSubmit}>
            ...
            <div class="scrum-form-section">
                ...
                <textarea id="description" rows="5" placeholder="Implementing JDBC template to communicate with our MySql database." bind:value={scrumDescription} contenteditable required></textarea>
            </div>
